  ...
  return (
    <section className="lg:max-w-6xl mx-auto flex flex-col z-0 items-center justify-center py-28 sm:pt-32 transition-all animate-in">
      <h1 className="py-6 text-center">
        ...
        <span className="underline underline-offset-8 decoration-dashed  decoration-[#4B88A2]">
          captivating
        </span>{" "}
        blog posts
      </h1>
      ...
      <Button
        variant={"link"}
        className="mt-6 text-xl rounded-full px-12 py-8 lg:mt-20 bg-gradient-to-r from-[#06D6A0] to-[#118AB2] hover:from-[#118AB2] hover:to-[#06D6A0] font-bold shadow-lg hover:no-underline"
      >
